...
#ifdef RTTOV
   use module_radiance, only : coefs, coef_scatt,rttov_coefs, rttov_scatt_coef, profile_type, profile_cloud_type,radiance_type, &
...
!      mpi_2double_precision
   ...
   use da_control, only : max_ob_levels,missing_r, &
      ...
      use_mwtsobs, use_mwhsobs, use_atmsobs, use_amsr2obs, use_gmiobs,&
